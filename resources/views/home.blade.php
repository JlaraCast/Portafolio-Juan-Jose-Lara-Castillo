                    ...
                    <div class="relative overflow-hidden group h-48 bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-indigo-600 dark:to-purple-700">
                        ...
                        <div class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-4">
                            @if($project->github_url)
                                <a href="{{ $project->github_url }}" target="_blank" rel="noopener noreferrer" class="p-2 bg-white rounded-full text-gray-900 hover:text-emerald-600 transition-colors" aria-label="{{ __('projects.view_code') }}: {{ $project->title['es'] ?? '' }}">
                            ...
                            @endif
                            @if($project->live_url)
                                <a href="{{ $project->live_url }}" target="_blank" rel="noopener noreferrer" class="p-2 bg-white rounded-full text-gray-900 hover:text-emerald-600 transition-colors" aria-label="{{ __('projects.live_demo') }}: {{ $project->title['es'] ?? '' }}">
