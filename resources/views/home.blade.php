                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white" id="modal-title" data-translate="contact.title">
                            ...
                            <div class="mt-4 space-y-4">
                                <a href="mailto:{{ $user->email }}" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                                ...
                                @if($user->phone)
                                <a href="tel:{{ $user->phone }}" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                                    <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-emerald-100 dark:bg-indigo-900/30 text-emerald-600 dark:text-indigo-400 group-hover:bg-emerald-200 dark:group-hover:bg-indigo-800 transition-colors">
                                ...
                                @if($user->linkedin)
                                <a href="{{ $user->linkedin }}" target="_blank" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                                    <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-emerald-100 dark:bg-indigo-900/30 text-emerald-600 dark:text-indigo-400 group-hover:bg-emerald-200 dark:group-hover:bg-indigo-800 transition-colors">
                                ...
                                @if($user->github)
                                <a href="{{ $user->github }}" target="_blank" class="flex items-center p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors group">
                                    <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-emerald-100 dark:bg-indigo-900/30 text-emerald-600 dark:text-indigo-400 group-hover:bg-emerald-200 dark:group-hover:bg-indigo-800 transition-colors">
