            ...
            <div class="border-b border-gray-100 dark:border-gray-700 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="month" name="start_date" id="start_date" value="" class="block w-full rounded-xl border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white sm:text-sm py-2.5 transition-colors" required>
                    </div>
                    <div id="end_date_container">
                        ...
                        <input type="month" name="end_date" id="end_date" value="" class="block w-full rounded-xl border-gray-300 dark:border-gray-600 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:text-white sm:text-sm py-2.5 transition-colors">
                    </div>
                </div>
                <div class="mt-4">
