...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Add New Skill</h2>
    ...
    <div class="bg-white shadow sm:rounded-lg p-6">
        <form action="{{ route('admin.skills.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="proficiency" id="proficiency" min="1" max="100" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
            </div>

            <div class="mb-6">
                <label for="icon" class="block text-sm font-medium text-gray-700">Icon (SVG or FontAwesome HTML)</label>
                <textarea name="icon" id="icon" rows="3" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="<i class='fab fa-php'></i>"></textarea>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Save Skill</button>
            </div>
        </form>
    </div>
</div>
