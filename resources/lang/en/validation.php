...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'description_es' => [
            'required' => 'The Spanish description is required.',
        ],
        'description_en' => [
        ...
        'image' => [
            ...
            'mimes' => 'The image must be a file of type: jpeg, png, jpg.',
            'max' => 'The image may not be greater than 2MB.',
            'dimensions' => 'The image dimensions must not exceed 2000x2000 pixels.',
        ],
        'skills.*' => [
            'exists' => 'One or more selected skills do not exist.',
        ],
        'company.es' => [
            'required' => 'The Spanish company name is required.',
        ],
        'company.en' => [
            'required' => 'The English company name is required.',
        ],
        'role.es' => [
            'required' => 'The Spanish role is required.',
        ],
        'role.en' => [
            'required' => 'The English role is required.',
        ],
        'period.es' => [
            'required' => 'The Spanish period is required.',
        ],
        'period.en' => [
            'required' => 'The English period is required.',
        ],
        'location.es' => [
            'required' => 'The Spanish location is required.',
        ],
        'location.en' => [
            'required' => 'The English location is required.',
        ],
        'logo' => [
            'image' => 'The logo must be an image.',
            'max' => 'The logo may not be greater than 2MB.',
            'dimensions' => 'The logo dimensions must not exceed 500x500 pixels.',
        ],
        'type' => [
            'required' => 'The experience type is required.',
            'in' => 'The type must be either work or education.',
        ],
        'name' => [
        ...
        'icon' => [
            'max' => 'The icon code is too large.',
        ],
    ],
