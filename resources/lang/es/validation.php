...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            'regex' => 'La contraseña debe contener al menos una letra minúscula, una mayúscula, un número y un carácter especial.',
        ],
        'title_es' => [
            'required' => 'El título en español es obligatorio.',
        ],
        'title_en' => [
            'required' => 'El título en inglés es obligatorio.',
        ],
        'description_es' => [
            'required' => 'La descripción en español es obligatoria.',
        ],
        'description_en' => [
            'required' => 'La descripción en inglés es obligatoria.',
        ],
        'image' => [
            'image' => 'El archivo debe ser una imagen.',
            'mimes' => 'La imagen debe ser un archivo de tipo: jpeg, png, jpg.',
            'max' => 'La imagen no puede ser mayor a 2MB.',
            'dimensions' => 'Las dimensiones de la imagen no deben exceder 2000x2000 píxeles.',
        ],
        'skills.*' => [
            'exists' => 'Una o más habilidades seleccionadas no existen.',
        ],
        'company.es' => [
            'required' => 'El nombre de la empresa en español es obligatorio.',
        ],
        'company.en' => [
            'required' => 'El nombre de la empresa en inglés es obligatorio.',
        ],
        'role.es' => [
            'required' => 'El rol en español es obligatorio.',
        ],
        'role.en' => [
            'required' => 'El rol en inglés es obligatorio.',
        ],
        'period.es' => [
            'required' => 'El periodo en español es obligatorio.',
        ],
        'period.en' => [
            'required' => 'El periodo en inglés es obligatorio.',
        ],
        'location.es' => [
            'required' => 'La ubicación en español es obligatoria.',
        ],
        'location.en' => [
            'required' => 'La ubicación en inglés es obligatoria.',
        ],
        'logo' => [
            'image' => 'El logo debe ser una imagen.',
            'max' => 'El logo no puede ser mayor a 2MB.',
            'dimensions' => 'Las dimensiones del logo no deben exceder 500x500 píxeles.',
        ],
        'type' => [
            'required' => 'El tipo de experiencia es obligatorio.',
            'in' => 'El tipo debe ser trabajo o educación.',
        ],
        'name' => [
            'required' => 'El nombre de la habilidad es obligatorio.',
            'unique' => 'Esta habilidad ya existe.',
        ],
        'icon' => [
            'max' => 'El código del ícono es demasiado grande.',
        ],
    ],
