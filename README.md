...
# Professional Portfolio - Juan José Lara Castillo

This is a professional portfolio website built with **Laravel** and **TailwindCSS**. It features a public-facing portfolio and a private admin dashboard to manage projects and skills.
...
1. **Clone the repository**:
   ...
   cd Portafolio-Juan-Jos--Lara-Castillo
   ```
...
4. **Database Setup**:
   Create an empty `database/database.sqlite` file (if using SQLite):
   ```bash
...
- Access the public portfolio at `http://localhost:8000`.
